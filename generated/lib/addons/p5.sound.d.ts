...
declare module '../../index' {
  ...
  interface PulseInstanceExtensions {
    /**
  ...
  interface NoiseInstanceExtensions {
    /**
  ...
  interface FilterInstanceExtensions {
    /**
  ...
  interface EQInstanceExtensions {
    /**
  ...
  interface DelayInstanceExtensions {
    /**
  ...
  interface ReverbInstanceExtensions {
    /**
  ...
  interface ConvolverInstanceExtensions {
    /**
  ...
  interface CompressorInstanceExtensions {
    /**
  ...
  interface DistortionInstanceExtensions {
    /**
