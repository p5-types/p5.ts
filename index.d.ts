...
declare class p5 {
   ...
   *   @chainable
   */
  colorMode(mode: p5.UNKNOWN_P5_CONSTANT, max1: number, max2: number, max3: number, maxA?: number): p5;
   ...
   *   @chainable
   */
  arc(x: number, y: number, w: number, h: number, start: number, stop: number, mode?: p5.ARC_MODE, detail?: number): p5;
   ...
   */
  cursor(type: string|p5.CURSOR_TYPE, x?: number, y?: number): void;
   ...
   *
   */
  deviceOrientation: p5.UNKNOWN_P5_CONSTANT;
   ...
   *
   */
  mouseButton: p5.UNKNOWN_P5_CONSTANT;
   ...
   *   SOFT_LIGHT, DODGE, BURN, ADD or NORMAL.
   */
  blend(sx: number, sy: number, sw: number, sh: number, dx: number, dy: number, dw: number, dh: number, blendMode: p5.UNKNOWN_P5_CONSTANT): void;
   ...
   */
  select(name: string, container?: string|p5.Element|HTMLElement): p5.Element|null;
   ...
   *   found
   */
  selectAll(name: string, container?: string): p5.Element[];
   ...
   *   @return pointer to p5.Element holding created node
   */
  createImg(src: string, alt?: string, successCallback?: Function): p5.Element;
   ...
   */
  createImg(src: string, successCallback: Function): object|p5.Element;
   ...
   *   element
   */
  createFileInput(callback?: Function, multiple?: string): p5.Element;
   ...
   */
  createVideo(src: string|string[], callback?: Function): p5.MediaElement;
   ...
   */
  createAudio(src?: string|string[], callback?: Function): p5.MediaElement;
  readonly VIDEO: p5.VIDEO;
  readonly AUDIO: p5.AUDIO;
   ...
   */
  createCapture(type: string|p5.TYPE|object, callback?: Function): p5.Element;
...
declare namespace p5 {
  ...
  class Element {
     ...
     *   @chainable
     */
    child(child?: string|p5.Element): p5.Element;
     ...
     *   @chainable
     */
    center(align?: string): p5.Element;
     ...
     *   @chainable
     */
    html(html?: string, append?: boolean): p5.Element;
     ...
     *   @chainable
     */
    style(property: string, value: string|number|p5.Color, value2?: string|number|p5.Color, value3?: string|number|p5.Color): p5.Element;
     ...
     *   @chainable
     */
    attribute(attr: string, value: string): p5.Element;
     ...
     *   @chainable
     */
    removeAttribute(attr: string): p5.Element;
     ...
     *   @chainable
     */
    value(value: string|number): p5.Element;
     ...
     *   @chainable
     */
    size(w: number|p5.SIZE_W, h?: number|p5.SIZE_H): p5.Element;
  ...
  class MediaElement {
     ...
     *   @chainable
     */
    autoplay(autoplay: boolean): p5.MediaElement;
     ...
     *   @chainable
     */
    volume(val: number): p5.MediaElement;
     ...
     *   @chainable
     */
    speed(speed: number): p5.MediaElement;
     ...
     *   @chainable
     */
    time(time: number): p5.MediaElement;
     ...
     *   @chainable
     */
    onended(callback: Function): p5.MediaElement;
  ...
  class Envelope {
     ...
     *   output
     */
    mult(number: number): p5.Envelope;
     ...
     *   output
     */
    scale(inMin: number, inMax: number, outMin: number, outMax: number): p5.Envelope;
  }
  ...
  class AudioIn {
     ...
     */
    getSources(successCallback?: Function, errorCallback?: Function): Promise<any>;
  ...
  class PeakDetect {
    ...
    // TODO: Annotate attribute "isDetected", defined in lib/addons/p5.sound.js, line 11484
